...
import { StatusBar, View, Image, Text, SafeAreaView, ImageBackground, ScrollView, Dimensions } from 'react-native';
...
class index extends Component {
  ...
  componentDidMount() {
    ServicesAPi.GetSoapRequest(this.handleGetSoapRequest);
  }
            ...
            <View style={{ paddingHorizontal: 20, alignItems: 'center' }} >
              ...
              <View style={styles.boxView}>
                <View style={styles.boxViewList}>
                  <ScrollView style={{ height: 0.7 * viewportHeight }}>
